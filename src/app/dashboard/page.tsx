...
export default function DashboardPage() {
  ...
  const handleDeleteOlympiad = async (olympiadId: string) => {
    ...
    try {
      ...
      alert(
        error instanceof Error ? error.message : 'Ошибка при удалении олимпиады'
      );
    } finally {
      setIsDeleting(false);
    }
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            ...
            >
              ...
              <p className="text-red-200/80">История участия и результаты</p>
            </button>
          </div>
                      ...
                      <div className="flex flex-col md:flex-row items-center gap-2">
                        {olympiad.isDraft ? (
                          ...
                          <>
                            ...
                            <button
                              onClick={() =>
                                router.push(`/olympiads/${olympiad.id}/manage`)
                              }
                              className="px-3 py-1 text-sm font-medium text-white bg-red-700 rounded-lg hover:bg-red-600 transition-colors"
                            >
                              Управление
