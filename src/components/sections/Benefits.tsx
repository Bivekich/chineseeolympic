...
export default function Benefits() {
  ...
  const benefits = [
    {
      title: 'Повышайте уровень',
      description:
        'Совершенствуйте свой китайский язык через практические задания разного уровня сложности',
      icon: '📚',
